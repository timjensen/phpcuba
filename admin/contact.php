...
//<![CDATA[
        bkLib.onDomLoaded(function() { nicEditors.allTextAreas({buttonList : ['bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat']}) });
  //]]>
  </script>
...
<div id='adminContainer'>
	<div id='adminWrapper'>
		...
		<div id='main'> <?php include '../includes/contact.php' ?></div>
	</div>
</div>
</body>
</html> <?php 
